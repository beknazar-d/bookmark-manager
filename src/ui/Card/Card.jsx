    ...
    return (
        <div className='card'>
            <section className='card__header'>
                ...
                <span className='card__header__text'>Frontend Mentor</span>
                <span className='card__header__undertext'>frontendmentor.io</span>
                </div>
                <button className='card__btn'><img src={menuIcon
                
                } alt="menu-icon" /></button>
            </section>
            <hr />
            <section className='card__content'>
                <p>Improve your front-end coding skills by building real projects.
                    Solve real-world HTML,
                    CSS and JavaScript
                    challenges whilst working to professional designs.</p>
                    <div >
            ...
            <section className='card__footer'>
                <div><img src={eye} alt="eye" /><span>47</span></div>
                <div><img src={hour} alt="hour" /> <span>23 Sep</span></div>
                <div><img src={data} alt="data" /><span>15 Jan</span></div>
