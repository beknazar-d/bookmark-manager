...
const cardsSlice = createSlice({
    ...
    reducers: {
        ...
        sortCards:(state)=>{
            state.filteredCards = sortCard(state.allCards,state.sortName)
        }
...
export const { setActiveSection, searchByName,addSearchedItem,addSortName,sortCards } = cardsSlice.actions;
